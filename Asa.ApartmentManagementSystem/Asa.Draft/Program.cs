...
namespace Asa.Draft
{
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            string yourconnection = @"Data source=.\DevInstance;initial catalog=ApartmentManagementSystem; User Id=sa;pwd=password1;" ;
            var baseInfoService = new BaseInfoApplicationService(yourconnection);
